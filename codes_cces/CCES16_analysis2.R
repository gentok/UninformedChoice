...
a1 <- gensimudata(mp3$imp1,dimp5$imputations$imp1,sq,cq,2016)
a2 <- gensimudata(mp3$imp2,dimp5$imputations$imp2,sq,cq,2016)
a3 <- gensimudata(mp3$imp3,dimp5$imputations$imp3,sq,cq,2016)
a4 <- gensimudata(mp3$imp4,dimp5$imputations$imp4,sq,cq,2016)
a5 <- gensimudata(mp3$imp5,dimp5$imputations$imp5,sq,cq,2016)
...
save(a1,a2,a3,a4,a5,a,p, file="codes_cces/processing/CCES16_analysis2.rda")
#load("codes_cces/processing/CCES16_analysis2.rda")
saveRDS(a, paste(projdir,"codes_cces/processing/simu16.rds", sep="/"))
