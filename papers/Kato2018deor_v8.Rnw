...
\begin{document}
    ...
    <<include=F>>=
    load("../outputs/CCES_analysis1.rda")
    load("../outputs/CCES16_analysis2.rda")
    load("../outputs/CCES08_analysis2.rda")
    load("../outputs/CCES_descriptives2.rda")
    ...
    <<knidxgraph2, echo=F,  warning=F, fig.width=6.5, fig.height=3.5, fig.align="center", dev="pdf", fig.pos='t!!!', fig.cap="Distribution of Political Knowledge Scales", message=F>>=
    knidxgraph
    @    
    ...
    <<pvigraph2, echo=F, warning=F, fig.width=6.5, fig.height=3.5, fig.align="center", dev="png", fig.pos='t!!!', fig.cap="Distribution of Social Information Variables", message=F>>=
    ...
    <<g2v_p, echo=F, warning=F, fig.width=8, fig.height=5, fig.align="center", dev="pdf", fig.pos='t!!!', fig.cap="The Impact of Social Information on Informed and Uninformed Voting Behavior (Presidential Elections)", message=F>>=
    grid.draw(g2v_p)
    @      
    ...
    <<g2v_h, echo=F, warning=F, fig.width=8, fig.height=5, fig.align="center", dev="pdf", fig.pos='t!!!', fig.cap="The Impact of Social Information on Informed and Uninformed Voting Behavior (Congressional Elections)", message=F>>=
    grid.draw(g2v_h)
    @
    ...
    <<gagp2v_p, echo=F, warning=F, fig.width=6.5, fig.height=6.5, fig.align="center", dev="pdf", fig.pos='t!!!', fig.cap="Only Uninformed Voters Bandwagon with Social Information (Presidential Elections)", message=F>>=
    grid.arrange(gagp2v_p08 + ggtitle("2008") + ylab(NULL) + xlab(NULL), 
                 gagp2v_p16 + ggtitle("2016") + ylab(NULL) + xlab(NULL),
                 left = "Predicted Two Party Share of Republican Vote",
                 bottom = "Partisan Voter Index",
                 nrow=2)
    @    
    
    <<gagp2v_h, echo=F, warning=F, fig.width=6.5, fig.height=6.5, fig.align="center", dev="pdf", fig.pos='t!!!', fig.cap="Uninformed Voters are More Strongly Pulled by Social Information Than Informed Voters (House Elections)", message=F>>=
    grid.arrange(gagp2v_h08 + ggtitle("2008") + ylab(NULL) + xlab(NULL), 
                 gagp2v_h16 + ggtitle("2016") + ylab(NULL) + xlab(NULL),
                 left = "Predicted Two Party Share of Republican Vote",
                 bottom = "House Partisan Voter Index",
                 nrow=2)
    @    
